              ...
              <div class="form-group">
                ...
                <div class="col-md-9">
                  <textarea class="form-control" id="message" name="message"
                    placeholder="Please Enter Your Reply Here..." rows="5"></textarea>
                </div>
              </div>

              <div class="form-group">
                <div class="col-md-12 text-right"><a href="AdminMagane.php"> <img src="Image/back.jpg" width="50px"
                      height="50px" alt="Bid" /> </a>
